...
import { Message } from "../../graphql/types/converted/index.mjs";
...
import { Action, CopilotErrorHandler, MaybePromise, NonEmptyRecord, Parameter, PartialBy } from "@copilotkit/shared";
import { CopilotRuntime, CopilotRuntimeOptions } from "@copilotkitnext/runtime";
 ...
 */
declare class CopilotRuntime$1<const T extends Parameter[] | [] = []> {
...
//#endregion
export { CopilotRuntime$1 as CopilotRuntime, CopilotRuntimeConstructorParams_BASE, copilotKitEndpoint, langGraphPlatformEndpoint, resolveEndpointType };

...
interface DynamicToolInput<ToolOutputT = ToolOutputType> extends BaseDynamicToolInput {
  func: (input: string, runManager?: CallbackManagerForToolRun, config?: ToolRunnableConfig) => Promise<ToolOutputT> | AsyncGenerator<unknown, ToolOutputT>;
}
/**
...
interface DynamicStructuredToolInput<SchemaT = ToolInputSchemaBase, SchemaOutputT = ToolInputSchemaOutputType<SchemaT>, ToolOutputT = ToolOutputType> extends BaseDynamicToolInput {
   ...
   */
  func: (input: SchemaOutputT, runManager?: CallbackManagerForToolRun, config?: RunnableConfig) => Promise<ToolOutputT> | AsyncGenerator<unknown, ToolOutputT>;
  schema: SchemaT;
}
/**

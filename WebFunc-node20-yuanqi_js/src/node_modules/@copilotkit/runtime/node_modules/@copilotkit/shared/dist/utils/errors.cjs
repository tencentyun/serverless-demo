...
async function getPossibleVersionMismatch({ runtimeVersion, runtimeClientGqlVersion }) {
	...
	if (require_index.COPILOTKIT_VERSION !== runtimeVersion || require_index.COPILOTKIT_VERSION !== runtimeClientGqlVersion || runtimeVersion !== runtimeClientGqlVersion) return {
		runtimeVersion,
		runtimeClientGqlVersion,
		reactCoreVersion: require_index.COPILOTKIT_VERSION,
		message: getVersionMismatchErrorMessage({
			runtimeVersion,
			runtimeClientGqlVersion,
			reactCoreVersion: require_index.COPILOTKIT_VERSION

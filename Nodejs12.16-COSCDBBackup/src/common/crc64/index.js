 ...
 * 
 * Modify by annexwu, add crc64Stream and crc64StreamPromise methods
 * 
...
module.exports.crc64Stream = function (stream, callback) {
  let errored = false;
  const crcPtr = strToUint64Ptr('0');
  let crcPtrFreed = false;
  stream.on('error', function (err) {
...
module.exports.crc64StreamPromise = promisify(module.exports.crc64Stream)
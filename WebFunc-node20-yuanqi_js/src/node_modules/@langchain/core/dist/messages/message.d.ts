 ...
 * ```
 */
interface MessageToolDefinition<TInput = unknown, TOutput$1 = unknown> {
  input: TInput;
  output: TOutput$1;
}
/**
 ...
 * ```
 */
interface MessageStructure<TTools$1 extends MessageToolSet = MessageToolSet> {
  /**

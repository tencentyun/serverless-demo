(/* istanbul ignore next */ function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', 'exports', '../util/decorate-service'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('../util/decorate-service'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.decorateService);
    global.interactionType = mod.exports;
  }
})(this, function (module, exports, _decorateService) {
  'use strict';

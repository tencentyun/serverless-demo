...
#####                                                                #####
#####   使用教程/readme:                                              #####
#####   https://cloud.tencent.com/document/product/583/307**         #####
#####                                                                #####
#####----------------------------------------------------------------#####
...
bucket_upload = "Tabor-ckafka-scf-cos-1251762227"  # Please replace with your COS bucket. 替换为需要写入的COS Bucket
...
def main_handler(event, context):
    ...
    with open(local_path, "a") as f:
        data = clsdata.decode("unicode-escape")

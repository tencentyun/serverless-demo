...
class FileCache {
  ...
  initFinish({ error = null, force = false, reason = '' } = {}) {
    ...
    if (force) {
      ...
      if (initTimer !== undefined && initTimer !== null) {

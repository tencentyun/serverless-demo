...
```
serverless init -t python2-ckafkatomysql
```
...
可以通过以下命令移除 CKAFKA数据备份MySQL

```console
$ sls remove 

serverless ⚡ framework
Action: "remove" - Stage: "dev" - App: "python2-ckafkatomysql" - Instance: "ap-guangzhou_default_python2-ckafkatomysql"

...
var NodeClient = /*#__PURE__*/function (_BaseClient) {
  _inheritsLoose(NodeClient, _BaseClient);

  function NodeClient(props) {
    var _this;

    _this = _BaseClient.call(this, props) || this;
    _this.props = props; // 页面reload时，通过code获取token
    // if (code !== null) {
  ...
  var _proto = NodeClient.prototype;
  ...
  _proto.setPkce = function setPkce(value) {
    this.pkce = value;
  };

  _proto.clearPkce = function clearPkce() {
    this.pkce = undefined;
  };
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              this.clearPkce();
              this.clearAuth();
              return _context.abrupt("return", Promise.resolve(url));
  ...
  _proto.generateAuthUrl = /*#__PURE__*/function () {
    var _generateAuthUrl = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2() {
      ...
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _this$props2 = this.props, _this$props2$protocol = _this$props2.protocol, protocol = _this$props2$protocol === void 0 ? ProtocolType.OIDC_PKCE : _this$props2$protocol, clientSecret = _this$props2.clientSecret;

              if (!((protocol == null ? void 0 : protocol.toString().toUpperCase()) === ProtocolType.OIDC_NORMAL)) {
                _context2.next = 9;
                break;
              }
    ...
    function generateAuthUrl() {
      return _generateAuthUrl.apply(this, arguments);
    }
  ...
  _proto.login = /*#__PURE__*/function () {
    var _login = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3() {
  ...
  /*#__PURE__*/
  function () {
    var _authorizeByNormal = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee4() {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              return _context4.abrupt("return", Promise.resolve(url));
  ...
  /*#__PURE__*/
  function () {
    var _authorize = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee5() {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 3:
              ...
              url = userDomain + "/oauth2/authorize?" + toUrlEncoded(query);
              return _context5.abrupt("return", Promise.resolve(url));
  ...
  /*#__PURE__*/
  function () {
    var _fetchToken = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee6(code, isRefresh) {
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _this$props5 = this.props, clientId = _this$props5.clientId, clientSecret = _this$props5.clientSecret, contentType = _this$props5.contentType, userDomain = _this$props5.userDomain, redirectUri = _this$props5.redirectUri, _this$props5$autoRefr = _this$props5.autoRefresh, autoRefresh = _this$props5$autoRefr === void 0 ? true : _this$props5$autoRefr, _this$props5$protocol = _this$props5.protocol, protocol = _this$props5$protocol === void 0 ? ProtocolType.OIDC_PKCE : _this$props5$protocol;
            ...
            case 12:
              ...
              if (autoRefresh) {
                console.log('autoRefresh'); // this.startTimer();
              }

              return _context6.abrupt("return", this.getAuthTokens());

            case 16:
              return _context6.abrupt("return", Promise.reject(new Error((response == null ? void 0 : response.message) || '未知错误')));
  ...
  _proto.armRefreshTimer = function armRefreshTimer(refreshToken, timeoutDuration) {
    ...
    this.timeout = window.setTimeout(function () {
      _this2.fetchToken(refreshToken, true).then(function (_ref) {
        var newRefreshToken = _ref.refresh_token,
...
export { NodeClient, ProtocolType };
//# sourceMappingURL=ciam-node-sdk.esm.js.map

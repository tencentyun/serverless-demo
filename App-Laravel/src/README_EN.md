# Quickly create and deploy laravel-starter application

[中文](./README.md) | **English**

## Introduction

Easily deploy laravel-starter applications to Tencent Cloud's serverless infrastructure using this Serverless Framework Component.

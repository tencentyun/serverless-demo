(/* istanbul ignore next */ function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', 'exports', './visible', '../util/context-to-element', '../util/element-matches', '../util/tabindex-value', './focus-relevant', '../util/get-frame-element', '../util/platform', '../util/image-map', './is.util', '../supports/supports'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('./visible'), require('../util/context-to-element'), require('../util/element-matches'), require('../util/tabindex-value'), require('./focus-relevant'), require('../util/get-frame-element'), require('../util/platform'), require('../util/image-map'), require('./is.util'), require('../supports/supports'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.visible, global.contextToElement, global.elementMatches, global.tabindexValue, global.focusRelevant, global.getFrameElement, global.platform, global.imageMap, global.is, global.supports);
    global.tabbable = mod.exports;
  }
})(this, function (module, exports, _visible, _contextToElement, _elementMatches, _tabindexValue, _focusRelevant, _getFrameElement, _platform, _imageMap, _is, _supports2) {
  'use strict';

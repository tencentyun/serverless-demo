...
describe('PhoneNumber', function () {
  ...
  it('should compare phone numbers', function () {
    expect(new PhoneNumber('RU', '8005553535', metadata).isEqual(new PhoneNumber('RU', '8005553535', metadata))).to.equal(true);
    expect(new PhoneNumber('RU', '8005553535', metadata).isEqual(new PhoneNumber('7', '8005553535', metadata))).to.equal(true);
    expect(new PhoneNumber('RU', '8005553535', metadata).isEqual(new PhoneNumber('RU', '8005553536', metadata))).to.equal(false);
  });
  ...
  it('should determine phone number type', function () {
    var phoneNumber = new PhoneNumber('US', '2015550000', metadata);

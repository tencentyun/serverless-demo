 ...
 * @public
 */
export declare type AbortSignal = typeof globalThis extends {
    AbortSignal: {
        prototype: infer T;
    };
} ? T : {
 ...
 * @public
 */
export declare interface ReadableStreamGetReaderOptions {
    mode?: 'byob';
}
 ...
 * @public
 */
export declare type ReadableStreamReader<R> = ReadableStreamDefaultReader<R> | ReadableStreamBYOBReader;

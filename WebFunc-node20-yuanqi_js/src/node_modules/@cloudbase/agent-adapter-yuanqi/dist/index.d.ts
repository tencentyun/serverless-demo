...
declare class YuanqiAgent extends AbstractAgent {
    ...
    private _run;
    protected getChatHistory(subscriber: Subscriber<BaseEvent>, input: RunAgentInput, latestUserMessage: Message): Promise<OpenAI.Chat.Completions.ChatCompletionMessageParam[]>;
...
declare function queryForLLM({ tcbClient, botId, conversation, pageSize, startCreatedAt, triggerSrc, }: {
    tcbClient: tcb.CloudBase;
    botId: string;
    conversation: string;
    pageSize?: number;

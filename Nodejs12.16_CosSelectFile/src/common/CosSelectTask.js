...
class CosSelectTask {
    ...
    Object.assign(this, {
      ...
      params: {
        ...
        uploadFiles: {
          ...
          Region: targetRegion,
          Key: targetKey,
          'x-cos-meta-scf-cos-select-file': 'true',
        },
      },
    });
  }
  ...
  async runTaskOnce() {
    try {
      ...
      if (hasLoopRisk) {
        return 'this cos object is a cos select result, to avoid loop trigger, we skip it';
      }
    } catch (error) {
      throw {
        trace: 'CosSelectTask.checkLoopRisk',
        error,
      };
    }
    try {
  ...
  async checkLoopRisk() {
    ...
    return (
      ...
      && headers['x-cos-meta-scf-cos-select-file']
      && headers['x-cos-meta-scf-cos-select-file'] === 'true'
    );
  }

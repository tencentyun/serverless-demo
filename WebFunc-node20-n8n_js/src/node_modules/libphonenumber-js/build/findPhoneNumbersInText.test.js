...
describe('findPhoneNumbersInText', function () {
  it('should find phone numbers in text (with default country)', function () {
    expect((0, _findPhoneNumbersInText["default"])('+7 (800) 555-35-35', 'US', _metadataMin["default"])[0].number.number).to.equal('+78005553535');
  });
  it('should find phone numbers in text (with default country in options)', function () {
    expect((0, _findPhoneNumbersInText["default"])('+7 (800) 555-35-35', {
      defaultCountry: 'US'
    }, _metadataMin["default"])[0].number.number).to.equal('+78005553535');
  });
  ...
  it('should find phone numbers in text (without default country, with options)', function () {
    expect((0, _findPhoneNumbersInText["default"])('+7 (800) 555-35-35', undefined, {}, _metadataMin["default"])[0].number.number).to.equal('+78005553535');
  });
  it('should find phone numbers in text (with default country, without options)', function () {
    expect((0, _findPhoneNumbersInText["default"])('+7 (800) 555-35-35', 'US', undefined, _metadataMin["default"])[0].number.number).to.equal('+78005553535');
  });
  ...
  it('should find numbers', function () {
    expect(findPhoneNumbersInTextWithResults('2133734253', {
      defaultCountry: 'US'
    ...
    expect(findPhoneNumbersInTextWithResults('(213) 373-4253', {
      defaultCountry: 'US'
    }, _metadataMin["default"])).to.deep.equal([{
      phone: '2133734253',
      country: 'US',
    ...
    expect(findPhoneNumbersInTextWithResults('The number is +7 (800) 555-35-35 and not (213) 373-4253 as written in the document.', {
      defaultCountry: 'US'
    }, _metadataMin["default"])).to.deep.equal([{
      phone: '8005553535',
      country: 'RU',
    ...
    expect(findPhoneNumbersInTextWithResults('The number is +7 (800) 555-35-35 and not (213) 373-4253 (that\'s not even in the same country!) as written in the document.', {
      defaultCountry: 'US'
    }, _metadataMin["default"])).to.deep.equal([{
      phone: '8005553535',
      country: 'RU',
    ...
    // No default country.
    expect(findPhoneNumbersInTextWithResults('The number is +7 (800) 555-35-35 as written in the document.', undefined, _metadataMin["default"])).to.deep.equal([{
      phone: '8005553535',
      country: 'RU',
      startsAt: 14,
      endsAt: 32
    ...
    expect(findPhoneNumbersInTextWithResults('The number is +7 (800) 555-35-35 as written in the document.', {
      defaultCountry: 'US',
      leniency: 'VALID'
    }, _metadataMin["default"])).to.deep.equal([{
      phone: '8005553535',
    ...
    expect(findPhoneNumbersInTextWithResults('Digits 12 are not a number, but +7 (800) 555-35-35 is.', {
      leniency: 'VALID'
    }, _metadataMin["default"])).to.deep.equal([{
      phone: '8005553535',
      country: 'RU',
    ...
    expect(findPhoneNumbersInTextWithResults('Date 02/17/2018 is not a number, but +7 (800) 555-35-35 ext. 123 is.', {
      leniency: 'VALID'
    }, _metadataMin["default"])).to.deep.equal([{
      phone: '8005553535',
      country: 'RU',
  ...
  it('shouldn\'t find non-valid numbers', function () {
    ...
    expect(findPhoneNumbersInTextWithResults('1111111111', {
      defaultCountry: 'US'
    }, _metadataMin["default"])).to.deep.equal([]);
  });
  it('should find non-European digits', function () {
    // E.g. in Iraq they don't write `+442323234` but rather `+٤٤٢٣٢٣٢٣٤`.
    expect(findPhoneNumbersInTextWithResults('العَرَبِيَّة‎ +٤٤٣٣٣٣٣٣٣٣٣٣عَرَبِيّ‎', undefined, _metadataMin["default"])).to.deep.equal([{
      country: 'GB',
      phone: '3333333333',
      startsAt: 14,
      endsAt: 27
  ...
  it('should work in edge cases', function () {
    ...
    // No input
    expect(findPhoneNumbersInTextWithResults('', undefined, _metadataMin["default"])).to.deep.equal([]);
  ...
  it('shouldn\'t find phone numbers which are not phone numbers', function () {
    // A timestamp.
    expect(findPhoneNumbersInTextWithResults('2012-01-02 08:00', {
      defaultCountry: 'US'
    }, _metadataMin["default"])).to.deep.equal([]);

    // A valid number (not a complete timestamp).
    expect(findPhoneNumbersInTextWithResults('2012-01-02 08', {
      defaultCountry: 'US'
    }, _metadataMin["default"])).to.deep.equal([{
      country: 'US',
      phone: '2012010208',
    ...
    // Invalid parens.
    expect(findPhoneNumbersInTextWithResults('213(3734253', {
      defaultCountry: 'US'
    }, _metadataMin["default"])).to.deep.equal([]);

    // Letters after phone number.
    expect(findPhoneNumbersInTextWithResults('2133734253a', {
      defaultCountry: 'US'
    }, _metadataMin["default"])).to.deep.equal([]);

    // Valid phone (same as the one found in the UUID below).
    expect(findPhoneNumbersInTextWithResults('The phone number is 231354125.', {
      defaultCountry: 'FR'
    }, _metadataMin["default"])).to.deep.equal([{
      country: 'FR',
      phone: '231354125',
    ...
    expect(findPhoneNumbersInTextWithResults('The UUID is CA801c26f98cd16e231354125ad046e40b.', {
      defaultCountry: 'FR'
    }, _metadataMin["default"])).to.deep.equal([]);
  });
  ...
  it('should return correct `startsAt` and `endsAt` when matching "inner" candidates in a could-be-a-candidate substring', function () {
    expect(findPhoneNumbersInTextWithResults('39945926 77200596 16533084', {
      defaultCountry: 'ID'
    }, _metadataMax["default"])).to.deep.equal([{
      country: 'ID',
      phone: '77200596',
      startsAt: 9,
      endsAt: 17

...
describe('findPhoneNumbersInText', function () {
  it('should find phone numbers in text (with default country)', function () {
    expect(findPhoneNumbersInText('+7 (800) 555-35-35', 'US', metadata)[0].number.number).to.equal('+78005553535');
  });
  it('should find phone numbers in text (with default country in options)', function () {
    expect(findPhoneNumbersInText('+7 (800) 555-35-35', {
      defaultCountry: 'US'
    }, metadata)[0].number.number).to.equal('+78005553535');
  });
  ...
  it('should find phone numbers in text (without default country, with options)', function () {
    expect(findPhoneNumbersInText('+7 (800) 555-35-35', undefined, {}, metadata)[0].number.number).to.equal('+78005553535');
  });
  it('should find phone numbers in text (with default country, without options)', function () {
    expect(findPhoneNumbersInText('+7 (800) 555-35-35', 'US', undefined, metadata)[0].number.number).to.equal('+78005553535');
  });
  ...
  it('should find numbers', function () {
    ...
    // No default country.
    expect(findPhoneNumbersInTextWithResults('The number is +7 (800) 555-35-35 as written in the document.', undefined, metadata)).to.deep.equal([{
      phone: '8005553535',
      country: 'RU',
      startsAt: 14,
      endsAt: 32
  ...
  it('should find non-European digits', function () {
    ...
    expect(findPhoneNumbersInTextWithResults('العَرَبِيَّة‎ +٤٤٣٣٣٣٣٣٣٣٣٣عَرَبِيّ‎', undefined, metadata)).to.deep.equal([{
      country: 'GB',
      phone: '3333333333',
      startsAt: 14,
      endsAt: 27

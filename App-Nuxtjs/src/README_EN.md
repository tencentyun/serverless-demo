# Quickly create and deploy nuxtjs-starter application

[中文](./README.md) | **English**

## Introduction

Easily deploy nuxtjs-starter applications to Tencent Cloud's serverless infrastructure using this Serverless Framework Component.
...
Initializing the nuxtjs-starter template by running this following command:

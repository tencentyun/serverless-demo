# Quickly create and deploy nextjs-starter application

[中文](./README.md) | **English**

## Introduction

Easily deploy nextjs-starter applications to Tencent Cloud's serverless infrastructure using this Serverless Framework Component.

...
```
serverless init -t python2-cdn-dispatch-log-jobs
```
...
可以通过以下命令移除 CDN日志存储任务分发函数

```console
$ sls remove 

serverless ⚡ framework
Action: "remove" - Stage: "dev" - App: "python2-cdn-dispatch-log-jobs" - Instance: "ap-guangzhou_default_python2-cdn-dispatch-log-jobs"

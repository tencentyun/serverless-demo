...
```
serverless init -t python2-ckafkatockafka
```
...
可以通过以下命令移除 CKAFKA同步至Ckafka

```console
$ sls remove 

serverless ⚡ framework
Action: "remove" - Stage: "dev" - App: "python2-ckafkatockafka" - Instance: "ap-guangzhou_default_python2-ckafkatockafka"

...
```
serverless init -t node8-unzipanduploadtocos
```
...
Action: "remove" - Stage: "dev" - App: "node8-unzipanduploadtocos" - Instance: "ap-guangzhou_default_node8-unzipanduploadtocos"

...
let req = new models.PullSmsReplyStatusByPhoneNumberRequest();
...
req.PhoneNumber = "+8615291996532";
/* 拉取起始时间，UNIX 时间戳（时间：秒） */
req.SendDateTime = 1577248386;

// 通过client对象调用想要访问的接口，需要传入请求对象以及响应回调函数
client.PullSmsReplyStatusByPhoneNumber(req, function (err, response) {
    // 请求异常返回，打印异常信息
    if (err) {
        console.log(err);
        return;

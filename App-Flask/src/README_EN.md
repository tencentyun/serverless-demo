# Quickly create and deploy flask-starter application

[中文](./README.md) | **English**

## Introduction

Easily deploy flask-starter applications to Tencent Cloud's serverless infrastructure using this Serverless Framework Component.

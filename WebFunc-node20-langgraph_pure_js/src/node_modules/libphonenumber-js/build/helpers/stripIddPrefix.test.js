...
describe('stripIddPrefix', function () {
  it('should strip a valid IDD prefix', function () {
    expect((0, _stripIddPrefix["default"])('01178005553535', 'US', '1', _metadataMin["default"])).to.equal('78005553535');
  });
  it('should strip a valid IDD prefix (no country calling code)', function () {
    expect((0, _stripIddPrefix["default"])('011', 'US', '1', _metadataMin["default"])).to.equal('');
  });
  it('should strip a valid IDD prefix (valid country calling code)', function () {
    expect((0, _stripIddPrefix["default"])('0117', 'US', '1', _metadataMin["default"])).to.equal('7');
  });

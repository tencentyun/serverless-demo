...
declare abstract class BaseChatOpenAI<CallOptions extends BaseChatOpenAICallOptions> extends BaseChatModel<CallOptions, AIMessageChunk> implements Partial<OpenAIChatInput> {
  ...
  stream(input: BaseLanguageModelInput, options?: CallOptions): Promise<_langchain_core_utils_stream0.IterableReadableStream<AIMessageChunk<_langchain_core_messages0.MessageStructure>>>;

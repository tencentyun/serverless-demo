...
const maybeMultipartFormRequestOptions = async (opts) => {
    if (!hasUploadableValue(opts.body))
        return opts;
    const form = await (0, exports.createForm)(opts.body, opts);
...
const createForm = async (body, opts) => {
...
const addFormValueJson = async (form, key, value) => {
    ...
    if (Array.isArray(value) || typeof value === 'object') {
        form.append(key, new index_1.File([JSON.stringify(value)], key, { type: 'application/json' }));
        return;
    }
